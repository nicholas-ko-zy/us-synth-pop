...
# unname it so I can access the array easier
two_tailed_alpha_pt05 <- unname(quantile(gaussian_Is_99_df$I, probs = c(0.025, 0.975)))
...
ggplot(gaussian_Is_99_df, aes(x = I)) +
  geom_histogram() +
  # Plotting the observed I value
  geom_vline(aes(xintercept = I_sp_noNAs$I),
             colour="red") + 
  # Plotting the 0.025 two tailed confidence interval (alpha = 0.05)
  sapply(two_tailed_alpha_pt05, function(xint) geom_vline(aes(xintercept = xint))) +
  theme_bw(base_size=22) + 
  ggtitle(TeX(r"(Normally Distributed Moran's I Value ($\alpha = 0.05$))")) +
  xlab("Simulated I (99 Trials)")
